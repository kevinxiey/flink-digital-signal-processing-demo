...
import utils.CountUDAF;
import utils.MachineToolWearData;
import utils.MachineToolWearDataSource;
import utils.PostgreSQLSink;
...
public class MachineToolWearDetectionJob {
    public static void main(String[] args) throws Exception {
        ...
        * */
        ...
        //6. interpret the insert-only Table as a DataStream again
        DataStream<Row> resultStream = tEnv.toDataStream(resultTable);

        //7. add a printing sink and execute in DataStream API
        resultStream.print();
